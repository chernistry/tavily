...
from tavily_scraper.stealth.device_profiles import build_context_options, choose_device_profile, choose_geo_profile

def test_region_alignment_eu():
...
def test_region_alignment_apac():
...
def test_geo_profile_alignment():
...
def test_random_geolocation_alignment():
